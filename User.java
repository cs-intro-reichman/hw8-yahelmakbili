...
public class User {
    ...
    public boolean addFollowee(String name) {
        if (fCount == maxfCount) {
            System.out.println("No more room for new followees for " + this.name);
            return false;
        }
        if (this.follows(name)) {
            System.out.println(name + " already followed by " + this.name);
            return false;
        }
        follows[fCount] = name;
        fCount++;
        System.out.println(name + " now followed by " + this.name);
        return true;
    }
    ...
    public boolean removeFollowee(String name) {
        ...
        fCount--;
        System.out.println("Removed " + name + " from " + this.name + "s follows");
        return true;
